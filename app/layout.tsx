...
export const metadata:Metadata={metadataBase:new URL("https://machiselect.jp"),title:"まちセレクト｜市町村別サービス比較",description:"地域の美容・生活・教育・仕事・住居サービスを、料金だけでなく条件や口コミまで比較。",alternates:{canonical:"/"}};
